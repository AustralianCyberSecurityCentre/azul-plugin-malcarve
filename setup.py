...
setup(
    name="azul-plugin-malcarve",
    description="Plugin to carve and feature obfuscated content from files.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_malcarve"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-malcarve = azul_plugin_malcarve.main:main",
        ]
    },
